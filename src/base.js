var v = {
	...
	mobile: false,
	alert: {title: "Update 0.10.1", showing: false, size: 0.8, content: "24/03/2017 ¦ •Added this changelog/alert button ¦ •If your phone is slow, the game will speed up so that it is less noticeable ¦ ¦ Thank you everyone who is testing this app, I really appreciate it. If you have any ideas for themes/modes/features, feel free to share them."}, //•
	scroll: 0,
	mode: "classic",
	themeOrder: 0,
	themes: [{name: "Default", player: "#000000", background: "#ffffff", obstacle: "#ff0000", unlock: ["score", 0], mode:"classic"},
			{name: "Negative", player: "#ffffff", background: "#000000", obstacle: "#0000ff", unlock: ["score", 10], mode:"classic"},
			{name: "Ice", player: "#0000ff", background: "#00ffff", obstacle: "#ffffff", unlock: ["score", 25], mode:"classic"},
			{name: "Magma", player: "#640000", background: "#ff0000", obstacle: "#c4a460", unlock: ["plays", 25], mode:"classic"},
			{name: "Forest", player: "#00FF00", background: "#654321", obstacle: "#228B22", unlock: ["plays", 50], mode:"classic"},
			{name: "Candy", player: "#ff00ff", background: "#ECB0E1", obstacle: "#551A8B", unlock: ["score", 50], mode:"classic"},
			{name: "Earth", player: "#A27035", background: "#A18276", obstacle: "#533E2D", unlock: ["score", 25], mode:"moving"},
			{name: "Rose", player: "#FFF275", background: "#A23E48", obstacle: "#6699CC", unlock: ["score", 25], mode:"clone"},
			{name: "Mountain", player: "#b8860b", background: "#add8e6", obstacle: "#a9a9a9", unlock: ["score", 25], mode:"patience"},
			{name: "Lavender", player: "#231942", background: "#5E548E", obstacle: "#E0B1CB", unlock: ["score", 25], mode:"tilt"},
			{name: "Autumn", player: "#69140E", background: "#A44200", obstacle: "#D58936", unlock: ["score", 25], mode:"veil"},
			{name: "Slate", player: "#6F6866", background: "#D3D0CB", obstacle: "#38515E", unlock: ["score", 25], mode:"chance"},
			{name: "Moonlight", player: "#fafaff", background: "#000032", obstacle: "#fafad2", unlock: ["plays", 100], mode:"moving", effect:"moon"},
			{name: "Command", player: "#B40000", background: "#000000", obstacle: "#00F000", unlock: ["plays", 100], mode:"clone", effect:"matrix"},
			{name: "Ocean", player: "#fff5ee", background: "#1e90ff", obstacle: "#2e8b57", unlock: ["plays", 100], mode:"patience", effect:"bubbles"},
			{name: "Stars", player: "#FFD700", background: "#000000", obstacle: "#555555", unlock: ["score", 75], mode:"classic", effect: "stars"},
		],
	unlockedThemes: 0,
