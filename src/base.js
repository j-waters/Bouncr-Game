var v = {
	...
	themes: [{name: "Default", player: "#000000", background: "#ffffff", obstacle: "#ff0000", unlock: ["score", 0], mode:"classic"},
			...
			{name: "Command", player: "#B40000", background: "#000000", obstacle: "#00F000", unlock: ["plays", 75], mode:"clone", effect:"matrix"},
			{name: "Ocean", player: "#fff5ee", background: "#1e90ff", obstacle: "#2e8b57", unlock: ["plays", 75], mode:"patience", effect:"bubbles"},
