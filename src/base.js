var v = {
	...
	themes: [{name: "Default", player: "#000000", background: "#ffffff", obstacle: "#ff0000", unlock: ["score", 0], mode:"classic"},
			...
			{name: "Earth", player: "#00FF00", background: "#654321", obstacle: "#228B22", unlock: ["plays", 50], mode:"classic"},
			{name: "Candy", player: "#C9DDFF", background: "#ECB0E1", obstacle: "#551A8B", unlock: ["score", 50], mode:"classic"},
			{name: "Mountain", player: "#b8860b", background: "#add8e6", obstacle: "#a9a9a9", unlock: ["score", 20], mode:"moving"},
			{name: "Moonlight", player: "#fafaff", background: "#000032", obstacle: "#fafad2", unlock: ["score", 25], mode:"veil", effect:"moon"},
			{name: "Command", player: "#B40000", background: "#000000", obstacle: "#00F000", unlock: ["score", 25], mode:"clone", effect:"matrix"},
			{name: "Ocean", player: "#fff5ee", background: "#1e90ff", obstacle: "#2e8b57", unlock: ["score", 25], mode:"patience", effect:"bubbles"},
