var v = {
	...
	themes: {"0": {name: "Default", player: "#000000", background: "#ffffff", obstacle: "#ff0000", unlock: ["score", 0], mode:"classic"},
			...
			"7": {name: "Moonlight", player: "#fafaff", background: "#000032", obstacle: "#fafad2", unlock: ["score", 25], mode:"veil"},
			"8": {name: "Matrix", player: "#B40000", background: "#000000", obstacle: "#00B400", unlock: ["score", 25], mode:"clone"},
			"8": {name: "Ocean", player: "#fff5ee", background: "#1e90ff", obstacle: "#2e8b57", unlock: ["score", 25], mode:"patience"},
		},
